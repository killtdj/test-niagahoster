...
<body class="body">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="feed-heading">
                    <img src="{{ asset('image/Path 1.png') }}" alt="">
                    <span>Gratis Ebook 9 Cara Cerdas Menggunakan Domain [ x ]</span>
                </div>
            </div>
            <div class="col-md-6">
    ...
    <div class="container">
        <div class="row">
            <nav class="navbar navbar-expand-lg">
                <img src="{{ asset('image/niagahoster-logo.png') }}" width="220" alt="" class="img-logo">
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6 hero-start">
                <h1>PHP Hosting</h1>
                <p>Cepat, handal, penuh dengan<br>
                    modul PHP yang Anda butuhkan
                </p>
                <ul class="fa-ul">
                    <li><span class="fa-li"><i class="fas fa-check-circle text-success"></i></span>Solusi PHP untuk
                        performa query yang lebih cepat.</li>
                    <li><span class="fa-li"><i class="fas fa-check-circle text-success"></i></span>Konsumsi memory yang
                        lebih rendah.</li>
                    <li><span class="fa-li"><i class="fas fa-check-circle text-success"></i></span>Support PHP 5.3, PHP
                        5.4, PHP 5.5, PHP 7</li>
                    <li><span class="fa-li"><i class="fas fa-check-circle text-success"></i></span>Fitur enkripsi
                        IonCube dan Zend Guard Loaders</li>
                </ul>
            </div>
            <div class="col-lg-6 hero-second">
                <img src="{{ asset('image/illustration banner PHP hosting.svg') }}" class="img-fluid" width="466"
                    alt="">
            </div>
        </div>
    </div>
            ...
            <table class="table table-responsive table-condensed my-5">
                <tr>
                    <td class="align-middle text-center"><img
                            src="{{ asset('image/svg/illustration-banner-PHP-zenguard01.svg') }}" class="img-fluid"
                            alt=""></td>
                    <td class="align-middle text-center"><img src="{{ asset('image/svg/icon-composer.svg') }}"
                            class="img-fluid" alt=""></td>
                    <td class="align-middle text-center"><img
                            src="{{ asset('image/svg/icon-php-hosting-ioncube.svg') }}" class="img-fluid" alt="">
                    </td>
                </tr>
                <tr>
        ...
        <div>
            ...
            <div class="row justify-content-center no-gutters">
                ...
                <div class="col-md-3 card-pricing-all">
                    ...
                    @endif
                    <div
                        class="card @if($product->name == 'Personal') card-pricing-blue @else card-pricing-light @endif">
                        <div
                            class="card-header 
    ...
    <div class="container">
        <div class="row justify-content-md-center m-5">
            ...
            <div class="col-sm-4">
                <div class="card">
                    <div class="card-body">
                        <img src="{{ asset('image/svg/icon PHP Hosting_My SQL remote.svg') }}"
                            class="img-section img-fluid" alt="">
    ...
    <div class="share-social-section vertical-center">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-6">
                    <span><b>Bagikan jika Anda menyukai halaman ini.</b></span>
                </div>
                <div class="col-md-6 d-flex justify-content-center">
                    <div class="social-media">
                        <i class="align-middle fab fa-facebook-square text-primary fa-3x"></i>
                        <span class="social-count py-2 px-3">100</span>
                    </div>
                    <div class="social-media">
                        <i class="align-middle fab fa-twitter-square text-info fa-3x"></i>
                        <span class="social-count py-2 px-3">100</span>
                    </div>
                    <div class="social-media">
                        <i class="align-middle fab fa-google-plus-square text-danger fa-3x"></i>
                        <span class="social-count py-2 px-3">100</span>
                    </div>
                </div>
            </div>
    ...
    <div class="support-contact-section vertical-center">
        <div class="container">
            <div class="row">
                <div class="col-md-8 support-contact-caption">
                    <span>Perlu <b>BANTUAN?</b> Hubungi Kami : <b>0274-5305505</b></span>
                </div>
                <div class="col-md-4 button-support">
                    <button class="btn btn-outline-light rounded-pill py-2 px-4"><i
                            class="fas fa-comments fa-lg px-2"></i>
                        Live Chat</button>
                </div>
            </div>
        </div>
    ...
    <div class="footer-section-1">
        <div class="container">
                ...
                <div class="col-md-3">
                    ...
                    <div>
                        <ul>
                            ...
                            <li><a href="#">Kemanan SSL / HTTPS</a></li>
            ...
            <div class="row pt-5">
                ...
                <div class="col-md-3">
                    ...
                    <div class="social-media-footer">
                        <a href=""><i class="fab fa-facebook-f text-light facebook"></i></a>
                        <a href=""><i class="fab fa-twitter text-light"></i></a>
                        <a href=""><i class="fab fa-google-plus-g text-light"></i></a>
                    </div>
                </div>
            </div>
            <div class="row pt-5">
            ...
            <span pt-5>Aktivasi instan dengan e-Payment. Hosting dan domain langsung aktif!</span>
        </div>
    </div>
    <div class="footer-section-2 vertical-center">
        <div class="container">
            <div class="row">
                <div class="col-md-9">
                    <span>Copyright &copy 2016 Niagahoster | Hosting powered by PHP7, CloudLinux, Cloudflare, BitNinja
                        and DC Biznet TechnoVillage Jakarta<br>Cloud VPS Murah powered by Webuzo Softaculous, Intel SSD
                        and Cloud Computing technology.</span>
                </div>
                <div class="col-md-3">
                    <span>
